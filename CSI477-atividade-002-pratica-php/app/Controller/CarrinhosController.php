...
class CarrinhosController extends AppController {
	...
	public function add_cliente() {
		...
		$this->Flash->success(__('Produto foi adicionado ao carrinho com sucesso!'));
		$this->redirect(array(
			'controller' => 'produtos',
	...
	public function add() {
		...
		$this->Flash->success(__('Produto adicionado ao carrinho com sucesso! Efetue login para finalizar a compra!'));
		$this->redirect(array(
			'controller' => 'produtos',
