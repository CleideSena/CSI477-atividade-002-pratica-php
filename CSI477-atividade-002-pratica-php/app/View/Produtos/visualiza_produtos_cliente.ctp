...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <?php foreach($produtos as $produto): ?>
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-info" align="center">
                      ...
                      <p>
                        ...
                        <?php echo $this->Form->create('Carrinho',array('id'=>'add-form','url'=>array('controller'=>'carrinhos','action'=>'add_cliente')));?>
              ...
              <strong><a href="<?php echo Router::url('http://localhost/CSI477-atividade-002-pratica-php/clientes/area_do_cliente'); ?>"><u>Voltar</u></a></strong>
    </div>
  </div>
